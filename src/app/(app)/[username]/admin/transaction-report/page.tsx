                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-blue-500 hover:bg-blue-600">
                                ...
                                <TableHead className="text-white font-semibold text-[16px] text-center">Amount (Rs)</TableHead>
                        ...
                        <TableFooter className="bg-gray-100">
                            <TableRow>
                                ...
                                <TableCell className="text-center font-semibold">Rs {totalAmount.toFixed(2)}</TableCell>
                                <TableCell colSpan={5} />
                            </TableRow>
                        </TableFooter>
                    </Table>
