                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-blue-500 hover:bg-blue-600">
                                ...
                                <TableHead className="text-white font-semibold text-[16px]">Price/Day (Rs)</TableHead>
                                <TableHead className="text-white font-semibold text-[16px]">Total Price (Rs)</TableHead>
