// src/components/owner/BookedBookedBikeCard.tsx
"use client";
        ...
        <Card className="w-full max-w-md mx-auto shadow-lg overflow-hidden transition-shadow hover:shadow-xl py-0 gap-3">
            ...
            <CardContent className="text-gray-800 text-sm px-4">
                ...
                <div className="mt-4 space-y-1 flex justify-between items-center">
                    {/* <span className="font-bold text-2xl"> Rs {bike.pricePerDay.toString()}/day</span> */}
            ...
            <CardFooter className="p-4! flex gap-2 justify-between border-t items-center">
                ...
                <div className="flex gap-2">
                    ...
                    <Link href={`/${currentUser.username}/owner/bikes/${booking.bike.id}`}>
